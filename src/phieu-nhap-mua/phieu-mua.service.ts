...
export class phieuMuaService {
    ...
    async deletePh71(stt_rec: string) {
        ...
        try {
            ...
            await queryRunner.manager.delete(Ct71Entity, { stt_rec });
            // 4. Xóa PH71
            await queryRunner.manager.delete(Ph71Entity, { stt_rec });
    ...
    async getAllPh71(page: number, limit: number, search: string) {
